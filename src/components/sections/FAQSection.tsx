...
const faqs = [
  {
    q: "감비환은 어떤 약인가요?",
    a: "감비환(減肥丸)은 체지방 분해를 돕고 기초대사량을 높여주는 한약입니다. 연간 8,000건 이상의 처방 데이터를 바탕으로 가장 효율적인 비방을 정립하여 만들어졌습니다.",
  },
  {
    q: "부작용은 없나요?",
  ...
  {
    q: "얼마나 빠질 수 있나요?",
    a: "2개월 기준 평균 10% 전후의 감량을 목표로 합니다. 과체중인 경우에는 더 잘 빠지는 편이며, 정상체중에서 마른체중으로 가는 경우에는 2개월 7% 감량을 목표로 합니다. 무리한 단기 감량보다 건강하고 지속 가능한 다이어트를 지향합니다.",
  },
  {
    q: "운동을 못 해도 효과가 있나요?",
  ...
  {
    q: "비용은 얼마인가요?",
    a: "1상자 기준 9만원이며, 1상자는 복용량에 따라 1~2개월간 복용하게 됩니다. 자세한 가격은 비용 안내 섹션을 참고해 주세요.",
  },
];
    ...
    <section className="py-20 md:py-28 bg-warm-50">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="space-y-3">
          {faqs.map((faq, i) => (
            <div key={i} className="bg-paper rounded-2xl shadow-sm overflow-hidden">
              <button
